...
This package is used to send sms messages via a wide variety of SMS providers.
...
``` bash
$ composer require panobit/sms-gateway
```
...
'providers' => [
    ...
    Panobit\SmsGateway\SmsServiceProvider::class,
],

# In your aliases array.
'aliases' => [
    ...
    'Sms' => Panobit\SmsGateway\Facade\Sms::class,
],
```
...
use Panobit\SmsGateway\Facade\Sms;
...
use Panobit\SmsGateway\Sms\SmsBuilder;
use Illuminate\Bus\Queueable;
use Panobit\SmsGateway\Channels\SmsChannel;
...
In your driver, You just have to extend `Panobit\SmsGateway\Abstracts\Driver`.
...
If you discover any security related issues, please email dev@panobit.com instead of using the issue tracker.
